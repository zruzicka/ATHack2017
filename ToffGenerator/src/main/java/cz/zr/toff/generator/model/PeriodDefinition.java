...
public class PeriodDefinition implements Definition {
    ...
    public PeriodDefinition(String from, String to, int queryPeriod, int returnOffset, Date start, int modelsAmount) {
        super();
        this.from = from;
        this.to = to;
